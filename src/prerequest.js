...
export default function calculateSignature(
  apiKey,
  apiSecret,
  path,
  body,
  ...
  let hmacFunction = new sjcl.misc.hmac(
    sjcl.codec.utf8String.toBits(apiSecret),
    sjcl.hash.sha256
  ); // Key, Hash
...
function w(a, b, c) {
  ...
  for (m = 0; m < n; m++)
    (h =
      a[e >>> 24] ^ r[(f >> 16) & 255] ^ v[(g >> 8) & 255] ^ y[b & 255] ^ d[p]),
      (l =
        a[f >>> 24] ^
        r[(g >> 16) & 255] ^
        v[(b >> 8) & 255] ^
...
sjcl.bitArray = {
  ...
  concat: function (a, b) {
    ...
    return 32 === d
      ? a.concat(b)
      : sjcl.bitArray.P(b, d, c | 0, a.slice(0, a.length - 1));
  },
...
sjcl.hash.sha256 = function (a) {
  this.b[0] || this.D();
  a
    ? ((this.r = a.r.slice(0)), (this.o = a.o.slice(0)), (this.h = a.h))
    : this.reset();
};
...
sjcl.mode.ocb2 = {
  ...
  decrypt: function (a, b, c, d, e, f) {
    ...
    h.equal(h.clamp(k, e), h.bitSlice(b, t)) ||
...
sjcl.mode.gcm = {
  ...
  p: function (a, b, c, d, e, f) {
    ...
    96 === h
      ...
      : ((e = sjcl.mode.gcm.g(g, [0, 0, 0, 0], e)),
        (e = sjcl.mode.gcm.g(g, e, [
          0,
          0,
...
sjcl.prng.prototype = {
  randomWords: function (a, b) {
    ...
    if (d & this.u) {
      ...
      for (
        d = 0;
        4 > d && !((this.f[d] = (this.f[d] + 1) | 0), this.f[d]);
        d++
      );
    }
    for (d = 0; d < a; d += 4)
